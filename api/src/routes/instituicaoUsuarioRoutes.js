...
router.post("/instituicao-usuario/solicitar",       autenticar, instituicaoUsuarioController.solicitar);
//Listar instituicoes do usuario logado (estar logado)
router.get("/instituicoes-usuario/logado",          autenticar, instituicaoUsuarioController.listarInstituicoes);
//Sair do vinculo com uma instituicao (estar logado fornecer o vinculo_id)
router.delete("/instituicao-usuario/sair",          autenticar, instituicaoUsuarioController.sair);
...
router.get("/usuarios-instituicao/:instituicao_id", autenticar, instituicaoUsuarioController.listarUsuarios);
